...
public class Ticket {
	...
	public JPanel ticketPanel(UserDetails uD) {
		...
		Title.setBounds(170,15,500,45);
		From.setBounds(20,80,300,20);
		To.setBounds(20,125,300,20);
		BookDate.setBounds(20,215,300,20);
		Price.setBounds(20,260,300,20);
		Time.setBounds(20,305,300,20);
		AdultsNo.setBounds(20,345,300,20);
		ChildrenNo.setBounds(20,385,300,20);
